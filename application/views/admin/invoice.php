          ...
          <tbody>
            ...
            foreach ($invoice as $inv) : ?>
              <tr>
                ...
                <td><a href="<?= base_url() . 'admin/invoice/detail/' . $inv->order_id ?>">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close" <?= $edit = "submit" ?> <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
